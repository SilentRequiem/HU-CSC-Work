...
print("I think it would be 3 because there are three 3s in 10")
...
print(divisonResult)
print("It has decimal places and it doesn't shave it off")
...
let mod: Int = 12 % 5 //5 * 2 = 10, 12 - 10 = 2
print(mod)
...
print("Odd")
print(odd / 2)
print("Even would always result in 0 while Odd can be anything that is not 0")
