...
var favoriteBook = Book(title: "One Piece", author: "Oda", pages: 100000, price: 99.99)
...
struct Laptop {
    ...
    var yearPurchased: Int //default
}

var personalLaptop = Laptop(yearPurchased: 2023)
var refurbishedLaptop = Laptop(screenSize: 14, repairCount: 3, yearPurchased: 2019)
...
var myHeight = Height(heightInCentimeters: 776.2000)
