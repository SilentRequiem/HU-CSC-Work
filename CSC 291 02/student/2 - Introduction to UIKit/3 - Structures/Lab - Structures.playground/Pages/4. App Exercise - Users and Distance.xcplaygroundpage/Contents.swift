...
var Michael = User(name: "Michael", age: 20, height: 64, weight: 123, activityLevel: 5)
print("My name is \(Michael.name). I am \(Michael.age), weigh \(Michael.weight) lbs and am \(Michael.height) inches tall. On an activity scale from 1-10 I am probably a \(Michael.activityLevel).")
...
let mile2 = Distance(meters: 7400)
print(mile2.feet)
