...
public class AmooM_Lab1
{
   ...
   System.out.println("CSC 152 Lab Fall 2024\n"); 
  ...
  //Other variables
   ...
   System.out.println("My full name contains " + totalChars + " number of characters.");
   System.out.println("My full name in uppercase is " + Ufull + ".");   
   System.out.println("The last character of my last name upper case is " + Lastchar + ".");                       
 ...
 //Part E
   ...
   if (num1 == num2)
      ...
      {
       System.out.println("Based on user input " + num1 + " and " + num2 + ", num1 is greater than num2.");
      }
    
   else
      {
       System.out.println("Based on user input " + num1 + " and " + num2 + ", num1 is less than num2.");
      }
